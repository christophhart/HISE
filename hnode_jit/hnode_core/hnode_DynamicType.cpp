...
void VariableStorage::setWithType(Types::ID newType, double value)
{
	switch (newType)
	{
	case hnode::Types::Float:	data.f.type = Types::ID::Float;
								data.f.value = static_cast<float>(value);
								break;
	case hnode::Types::Double:	data.d.type = Types::ID::Double;
								data.d.value = value; 
								break;
	case hnode::Types::Integer:	data.i.type = Types::ID::Integer;
								data.i.value = static_cast<int>(value);
								break;
	case hnode::Types::Dynamic:	data.d.type = Types::ID::Dynamic;
								data.d.value = value;
								break;
	default:
		jassertfalse;
...
hnode::FloatType VariableStorage::toFloat() const
{
	if (getTypeValue() == Types::ID::Float)
		return data.f.value;
...
hnode::block VariableStorage::toBlock() const
{
...
hnode::VariableStorage& VariableStorage::operator=(const Types::FloatBlock& s)
{
	data.b = s;
	return *this;
}

hnode::VariableStorage& VariableStorage::operator=(FloatType s)
{
	data.f.value = s;
	data.f.type = Types::ID::Float;
