...
hnode::jit::BlockParser::StatementPtr NewFunctionParser::parseStatementBlock()
{
...
hnode::jit::BlockParser::StatementPtr NewFunctionParser::parseVariableDefinition(bool isConst)
{
...
hnode::jit::BlockParser::StatementPtr NewFunctionParser::parseLoopStatement(bool isInterleavedLoop)
{
...
hnode::jit::BlockParser::StatementPtr NewFunctionParser::parseAssignment()
{
...
hnode::jit::BlockParser::ExprPtr NewFunctionParser::parseLogicOperation()
{
...
hnode::jit::BlockParser::ExprPtr NewFunctionParser::parseSum()
{
...
hnode::jit::BlockParser::ExprPtr NewFunctionParser::parseCast(Types::ID type)
{
	match(JitTokens::closeParen);
...
hnode::jit::BlockParser::ExprPtr NewFunctionParser::parseUnary()
{
