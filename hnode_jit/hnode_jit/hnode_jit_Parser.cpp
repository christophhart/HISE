...
class ClassCompiler : public BaseCompiler
{
public:
...
{
	ScopedPointer<Operations::Function> func = new Operations::Function(location);
...
hnode::VariableStorage BlockParser::parseVariableStorageLiteral()
{
...
hnode::jit::Operations::FunctionCompiler& Operations::getFunctionCompiler(BaseCompiler* c)
{
...
hnode::jit::BaseScope* Operations::findFunctionScope(BaseScope* scope)
{
	if (scope == nullptr)
		return nullptr;
...
hnode::VariableStorage Operations::Expression::getConstExprValue() const
{
	if (isConstExpr())
