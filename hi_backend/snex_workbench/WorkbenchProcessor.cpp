...
void DspNetworkCompileExporter::createProjucerFile()
{
	...
	auto shouldUseFaust = BackendDllManager::shouldIncludeFaust(getMainController());
	REPLACE_WILDCARD_WITH_STRING("%HISE_INCLUDE_FAUST%", shouldUseFaust ? "enabled" : "disabled");
