...
"		 <CONFIGURATION isDebug = \"0\" name = \"CI\" targetName=\"%CI_DLL_NAME%\" headerPath =\"%FAUST_HEADER_PATH%\" libraryPath=\"%WIN_STATIC_LIB_FOLDER_R64%\" binaryPath = \"dll\"\r\n"
...
"<XCODE_MAC targetFolder=\"Builds/MacOSX\" extraDefs=\"%EXTRA_DEFINES_OSX%\" extraLinkerFlags=\"%OSX_STATIC_LIBS%\" externalLibraries=\"%OSX_EXTERNAL_LIBRARIES%\" extraCompilerFlags=\"-Wno-reorder -Wno-inconsistent-missing-override -faligned-allocation -ffp-contract=off\" xcodeValidArchs=\"arm64,arm64e,x86_64\">\r\n"
"      <CONFIGURATIONS>\r\n"
...
"						libraryPath=\"%OSC_STATIC_LIB_FOLDER_RELEASE%\" binaryPath = \"dll\"\r\n"
...
"      </MODULEPATHS>\r\n"
"    </XCODE_MAC>\r\n"
"<MACOSX_MAKE targetFolder=\"Builds/MacOSXMakefile\" extraDefs=\"%EXTRA_DEFINES_OSX%\"\r\n"
"             extraLinkerFlags=\"%OSX_STATIC_LIBS% -Wl,-ld_new\" externalLibraries=\"%OSX_EXTERNAL_LIBRARIES%\"\r\n"
"             extraCompilerFlags=\"-Wno-reorder -Wno-inconsistent-missing-override -faligned-allocation -ffp-contract=off\"\r\n"
"             compileFirstPatterns=\"*hi_tools_01*\">\r\n"
"      <CONFIGURATIONS>\r\n"
"        <CONFIGURATION isDebug=\"1\" name=\"Debug\" osxArchitecture=\"%MACOS_MAKE_ARCHITECTURE%\" headerPath=\"%FAUST_HEADER_PATH%\"\r\n"
"                       libraryPath=\"%OSC_STATIC_LIB_FOLDER_DEBUG%\" binaryPath=\"dll\" targetName=\"%DEBUG_DLL_NAME%\"/>\r\n"
"        <CONFIGURATION isDebug=\"0\" name=\"CI\" osxArchitecture=\"%MACOS_MAKE_ARCHITECTURE%\" headerPath=\"%FAUST_HEADER_PATH%\"\r\n"
"                       libraryPath=\"%OSC_STATIC_LIB_FOLDER_RELEASE%\" binaryPath=\"dll\" optimisation=\"4\" linkTimeOptimisation=\"0\" targetName=\"%CI_DLL_NAME%\"/>\r\n"
