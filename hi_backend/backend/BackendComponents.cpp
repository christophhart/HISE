...
PopupPluginPreview::PopupPluginPreview(BackendProcessorEditor *editor_) :
...
void PopupPluginPreview::closeButtonPressed()
{
...
PopupPluginPreview::Content::Content(BackendProcessorEditor *editor_) :
editor(editor_),
