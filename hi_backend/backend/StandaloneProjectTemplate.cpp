...
"  </MAINGROUP>\r\n"
"  <EXPORTFORMATS>\r\n"
"    <%VS_VERSION% targetFolder=\"Builds/%TARGET_FOLDER%/\" IPP1ALibrary=\"%IPP_1A%\"  %ICON_FILE% extraDefs=\"%EXTRA_DEFINES_WIN%,%PERFETTO_INCLUDE_WIN%\"  extraLinkerFlags=\"%UAC_LEVEL%\" extraCompilerFlags=\"/bigobj /cgthreads8 %MSVC_WARNINGS% %PERFETTO_COMPILER_FLAGS_WIN%\">\r\n"
"      <CONFIGURATIONS>\r\n"
