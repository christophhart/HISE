...
public:
	...
	struct FloatingTileScreenshotProvider : public MarkdownParser::ImageProvider
	{
		FloatingTileScreenshotProvider(MarkdownParser* parent) :
			ImageProvider(parent)
		{};

		MarkdownParser::ResolveType getPriority() const override { return MarkdownParser::ResolveType::Autogenerated; }
		Identifier getId() const override { RETURN_STATIC_IDENTIFIER("FloatingTileScreenshotProvider"); }
		ImageProvider* clone(MarkdownParser* newParent) const override { return new FloatingTileScreenshotProvider(newParent); }
