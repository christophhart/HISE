...
struct MenuReferenceDocGenerator
{
	...
	public:
		...
		LinkResolver* clone(MarkdownParser* parent) const override { return new Resolver(*this); }
	...
	public:
		...
		MarkdownParser::ResolveType getPriority() const override { return MarkdownParser::ResolveType::Autogenerated; }
		LinkResolver* clone(MarkdownParser* parent) const override { return new MenuGenerator(data->bp); }
		String getContent(const MarkdownLink& url) override;
	...
	public:
		...
		MarkdownParser::ResolveType getPriority() const override { return MarkdownParser::ResolveType::Autogenerated; }
		LinkResolver* clone(MarkdownParser* parent) const override { return new SettingsGenerator(bp); }
		String getContent(const MarkdownLink& url) override;
