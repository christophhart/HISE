...
author: "")" },
    ...
    auto& Column_10 = List_0.addChild<Column>({
...
name:Author;max-width: 140px;width: 110px;)" },
    ...
    List_0.addChild<MarkdownText>({
      { mpid::Text, "A first starting point to building broadcasters." },
...
rebuildTable();
    ...
    auto& Column_23 = List_22.addChild<Column>({
      { mpid::Class, ".header-label" }
    });

    Column_23.addChild<SimpleText>({
      { mpid::Text, "Snippet Browser" },
      { mpid::Class, "#headerlabel" },
      { mpid::Style, "flex-grow: 1;" }
    });

    Column_23.addChild<Button>({
      { mpid::ID, "applyButton" },
...
author: "")" },
    ...
    auto& List_33 = List_22.addChild<List>({
      { mpid::Style, "background: #282828; padding: 20px; border-radius: 3px; border: 1px solid #444;" }
    });

    List_33.addChild<Button>({
      { mpid::Text, "Snippets" },
    ...
    auto& List_40 = mp.addPage<List>({
      { mpid::Style, "height: 100%;" }
    });

    auto& Column_41 = List_40.addChild<Column>({
      { mpid::Class, ".header-label" }
    });

    Column_41.addChild<SimpleText>({
      { mpid::Text, "Edit Snippet" },
      { mpid::ID, "editTitle" },
      { mpid::Style, "flex-grow: 1;" }
    });

    Column_41.addChild<Button>({
      { mpid::ID, "closeButton" },
    ...
    auto& List_44 = List_40.addChild<List>({
    ...
    auto& Column_46 = List_44.addChild<Column>({
      { mpid::Style, "gap:1px;height: auto;" }
    });

    Column_46.addChild<Button>({
      { mpid::Text, "All" },
      { mpid::ID, "addCategory" },
      { mpid::InitValue, "0" },
      { mpid::UseInitValue, 1 },
...
Private)" }
    ...
    List_44.addChild<MarkdownText>({
      { mpid::Text, "Explores the ScriptAPI Date Object. " },
      { mpid::ID, "descriptionPreview" },
      { mpid::Class, ".description" },
      { mpid::Style, "font-size: 18px; height: 180px;" }
    });

    List_44.addChild<Button>({
      { mpid::Text, "Save file" },
    ...
    List_44.addChild<JavascriptFunction>({
      { mpid::CallOnNext, 0 },
      { mpid::Code, R"(
...
document.getElementById("description").addEventListener("change", function()
{
    ...
    List_40.addChild<JavascriptFunction>({
      { mpid::CallOnNext, 1 },
...
if(state.newName.length > 0)
{
    ...
    // Custom callback for page List_40
    List_40.setCustomCheckFunction([](Dialog::PageBase* b, const var& obj){
