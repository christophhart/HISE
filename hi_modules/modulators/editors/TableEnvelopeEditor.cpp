...
//==============================================================================
TableEnvelopeEditorBody::TableEnvelopeEditorBody (BetterProcessorEditor *p)
    : ProcessorEditorBody(p)
{
    ...
    addAndMakeVisible (attackTable = new TableEditor (static_cast<TableEnvelope*>(getProcessor())->getTable(TableEnvelope::Attack)));
    attackTable->setName ("new component");

    addAndMakeVisible (releaseTable = new TableEditor (static_cast<TableEnvelope*>(getProcessor())->getTable(TableEnvelope::Release)));
