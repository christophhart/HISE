    ...
    : ProcessorEditorBody(pe)
{
    ...
    addAndMakeVisible (midiTable = new TableEditor (getProcessor()->getMainController()->getControlUndoManager(), dynamic_cast<GainMatcherModulator*>(getProcessor())->getTable(0)));
