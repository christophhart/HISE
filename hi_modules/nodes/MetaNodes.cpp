...
namespace split1_impl
{
// Template Alias Definition =======================================================
using chain1_ = container::chain<stk::jc_rev, core::gain>;
using split1_ = container::split<core::gain, chain1_>;

struct instance : public hardcoded<split1_>
{
	SET_HISE_NODE_ID("split1");
	GET_SELF_AS_OBJECT(instance);
	SET_HISE_NODE_IS_MODULATION_SOURCE(false);

	String getSnippetText() const override
	{
		return "652.3oc6U8zZSDDG82jjo1ZZoHhGT7fG5AQnARZTuYVMAk.IwX2TkBBx1MiIqI6NK6NowU76POJ5E+J3UOHD7tdP+F3IAunGzq5L6l+La1s1DHPonys42LC+du27l2Ti1j.Hb4R.ZYrqcWCVV31Z5LpiWcMVa.cFrN0hoYXQbx3uNTqmYw1ZVVjtt7ShR..Tgp2ITYTR01z900bzLILhinRBTRo4.Jw3Y.Jkn+KgaXXRfpFV2WqaONpVIELbTU6oSU66EhT.gJR4sWmYPsDMPZJfRWiSzxM46G+D8G4P1OKLt+hxqg2lrOwYuK4iA9I4S7g1owkaRrXFLO3t1M7rIhRpDVP6KGrulBFOa.eCkJz9DmJFlboTZm6XaGo5FJpLhspwy7O+lEu329x0tPA0Nj9AWQxrGlVNWFeSSZOK17Kn+5xO7f2+yuFQPSDqfdJbKt6Xqvx4R36vKJqiowOfvFhn4VH2cPT.KbcQExcGDmPBfrP9pWJFuMrPhuZl74xk65.7WXY1ilkkb7NQvRAw7uTqMIAXDICE.jlG.3PxHVYFe5eKOaMW2s0LsEOlp5NAg4U37l1rWWMg71PyoEgwAAT2gxoCyH.QCm4AnjBTsJ+oo6HELh7Tu2dcMzEsEl5bqi2wkLqG8vRlRerekk5F5u6Csdy4TBxH8cbi63lO9SO+EUux.YO65Cywyb39P4vhUl6LLkCl8LL9dOZF9auWW+rk9bAACSiUMoTVaCqVSeikWApI+ckd6ntU4uq7WeQ3YSHaOh8kyjeUBglUwtrNYBVZg.jXe7H6cQyt2cw96zX+br+NIznvewFowxV30FYg82ZbF3HoVa8+TqSLoV+.t24+XQz+LoVxFE3OOTF8VA";
	}
	...
	void createParameters(Array<ParameterData>& data)
	{
		// Node Registration ===============================================================
		registerNode(get<0>(obj), "gain1");
		registerNode(get<1, 0>(obj), "jc_rev1");
		registerNode(get<1, 1>(obj), "gain3");

		// Parameter Initalisation =========================================================
		setParameterDefault("gain1.Gain", -13.1515);
		setParameterDefault("gain1.Smoothing", 20.0);
		setParameterDefault("jc_rev1.Reverb Time", 10.0);
		setParameterDefault("gain3.Gain", -2.15811);
		setParameterDefault("gain3.Smoothing", 20.0);

		// Setting node properties =========================================================
		setNodeProperty("gain1.ResetValue", 0, false);
		setNodeProperty("gain1.UseResetValue", 0, false);
		setNodeProperty("gain3.ResetValue", 0, false);
		setNodeProperty("gain3.UseResetValue", 0, false);

		// Parameter Callbacks =============================================================
		{
			ParameterData p("Time", { 0.0, 1.0, 0.01, 1.0 });

			auto param_target1 = getParameter("jc_rev1.Reverb Time", { 0.0, 10.0, 0.0001, 1.0 });
		...
		}
		{
			...
			auto param_target1 = getParameter("gain3.Gain", { -100.0, 0.0, 0.1, 5.42227 });
			param_target1.addConversion(ConverterIds::WetAmount);
			auto param_target2 = getParameter("gain1.Gain", { -100.0, 0.0, 0.1, 5.42227 });
			param_target2.addConversion(ConverterIds::DryAmount);
...
using split1 = split1_impl::instance;
