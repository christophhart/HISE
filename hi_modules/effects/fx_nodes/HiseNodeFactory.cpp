	...
	NodeFactory(network)
{
	...
	registerNode<HiseDspNodeBase<core::oscillator_poly>>();
	registerNode<HiseDspNodeBase<core::ramp_envelope>>();
	registerNode<HiseDspNodeBase<core::ramp_envelope_poly>>();
	registerNode<HiseDspNodeBase<core::gain>>();
	registerNode<HiseDspNodeBase<core::peak>>();
    registerNode<HiseDspNodeBase<core::panner>>();
