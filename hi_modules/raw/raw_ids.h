...
static constexpr int Audio = MainController::KillStateHandler::AudioThread;

/** The main message thread. */
static constexpr int Message = MainController::KillStateHandler::MessageThread;
...
*/
static constexpr int Loading = MainController::KillStateHandler::SampleLoadingThread;
...
*/
static constexpr int Script = MainController::KillStateHandler::ScriptingThread;
}
