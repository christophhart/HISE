...
xcopy "xml\class_scripting_objects_1_1_script_slider_pack_data.xml" "xml\selection"
...
ren "xml\selection\class_scripting_api_1_1_module_ids.xml" "ModuleIds.xml"
...
ren "xml\selection\class_scripting_objects_1_1_script_slider_pack_data.xml" "SliderPackData.xml"
ren "xml\selection\class_scripting_objects_1_1_scripting_message_holder.xml" "MessageHolder.xml"
