...
SET standalone_project="projects\standalone\Builds\VisualStudio2013\HISE Standalone.sln"

REM This is the project folder of the plugin project
SET plugin_project="projects\plugin\Builds\VisualStudio2013\HISE.sln"
