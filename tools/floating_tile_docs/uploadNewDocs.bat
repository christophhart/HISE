...
echo mdel "html/hise/floating_tile_api/*.*">> upload.ftp
echo mdel "html/hise/floating_tile_api/search/*.*">> upload.ftp
echo cd "html/hise/floating_tile_api/">> upload.ftp
