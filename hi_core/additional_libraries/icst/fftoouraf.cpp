// modified, from Ooura's FFT package (www.kurims.kyoto-u.ac.jp/~ooura)
...
void cftb1st(int n, float *a)
{
    ...
    wd3r = 1.0f;
    wd3i = 0;
    ew = static_cast<float>(M_PI_2 / m);
    w1r = static_cast<float>(cos(2.0f * ew));
    w1i = static_cast<float>(sin(2.0f * ew));
    wk1r = w1r;
    wk1i = w1i;
    ss1 = 2.0f * w1i;
    wk3i = 2.0f * ss1 * wk1r;
    ...
    for (;;) {
        ...
        wd1r = static_cast<float>(cos(ew * i0));
        wd1i = static_cast<float>(sin(ew * i0));
        wd3i = 4.0f * wd1i * wd1r;
        wd3r = wd1r - wd3i * wd1i;
        wd3i = wd1i - wd3i * wd1r;
...
void cftmdl2(int n, float *a)
{
    ...
    we3r = -wn4r;
    we3i = -wn4r;
    ew = static_cast<float>(M_PI_2 / (2 * m));
    w1r = static_cast<float>(cos(2.0f * ew));
    w1i = static_cast<float>(sin(2.0f * ew));
    wk1r = w1r;
    wk1i = w1i;
    ...
    for (;;) {
        ...
        wl1r = static_cast<float>(cos(ew * i0));
        wl1i = static_cast<float>(sin(ew * i0));
        wl3i = 4.0f * wl1i * wl1r;
        wl3r = wl1r - wl3i * wl1i;
        wl3i = wl1i - wl3i * wl1r;
        we1r = wn4r * (wl1r - wl1i);
    ...
    wl1r = static_cast<float>(WR2500);
    wl1i = static_cast<float>(WI2500);
    j0 = mh;
    j1 = j0 + m;
    j2 = j1 + m;
    j3 = j2 + m;
...
void cftf161(float *a)
{
    ...
    wn4r = static_cast<float>(WR5000);
    wk1r = static_cast<float>(WR2500);
    wk1i = static_cast<float>(WI2500);
    x0r = a[0] + a[16];
    x0i = a[1] + a[17];
    x1r = a[0] - a[16];
    x1i = a[1] - a[17];
...
void cftf162(float *a)
{
    ...
    wn4r = static_cast<float>(WR5000);
    wk1r = static_cast<float>(WR1250);
    wk1i = static_cast<float>(WI1250);
    wk2r = static_cast<float>(WR2500);
    wk2i = static_cast<float>(WI2500);
    wk3r = static_cast<float>(WR3750);
    wk3i = static_cast<float>(WI3750);
    x1r = a[0] - a[17];
    x1i = a[1] + a[16];
    x0r = a[8] - a[25];
    x0i = a[9] + a[24];
...
void rftfsub(int n, float *a)
{
    ...
    ec = 2.0f * static_cast<float>(M_PI_2 / n);
    wkr = 0;
    wki = 0;
    wdi = static_cast<float>(cos(ec));
    wdr = static_cast<float>(sin(ec));
    wdi *= wdr;
    wdr *= wdr;
    w1r = 1.0f - 2.0f * wdr;
    w1i = 2.0f * wdi;
    ...
    for (;;) {
        ...
        wkr = 0.5f * static_cast<float>(sin(ec * i0));
        wki = 0.5f * static_cast<float>(cos(ec * i0));
        wdr = 0.5f - (wkr * w1r - wki * w1i);
        wdi = wkr * w1i + wki * w1r;
        wkr = 0.5f - wkr;
        i = i0;
    }
...
void dctsub(int n, float *a)
{
    ...
    ec = static_cast<float>(M_PI_2 / n);
    wkr = 0.5f;
    wki = 0.5f;
    w1r = static_cast<float>(cos(ec));
    w1i = static_cast<float>(sin(ec));
    wdr = 0.5f * (w1r - w1i);
    wdi = 0.5f * (w1r + w1i);
    ss = 2.0f * w1i;
    m = n >> 1;
    ...
    for (;;) {
        ...
        wdr = static_cast<float>(cos(ec * i0));
        wdi = static_cast<float>(sin(ec * i0));
        wkr = 0.5f * (wdr - wdi);
        wki = 0.5f * (wdr + wdi);
        wdr = wkr * w1r - wki * w1i;
        wdi = wkr * w1i + wki * w1r;
...
void dctsub4(int n, float *a)
{
    ...
    wki = static_cast<float>(WR5000);
    m = n >> 1;
    if (m == 2) {
        wdr = wki * static_cast<float>(WI2500);
        wdi = wki * static_cast<float>(WR2500);
        xr = wdi * a[1] - wdr * a[3];
        a[1] = wdr * a[1] + wdi * a[3];
        a[3] = xr;
    }
